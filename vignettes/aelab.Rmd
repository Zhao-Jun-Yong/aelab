...
When `fit_type = "auto"`, analyser precision is looked up automatically from the built-in `analyzer_precision` dataset (LI-7810 and LI-7820) if `instrument_precision` is not supplied.
