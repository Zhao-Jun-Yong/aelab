...
```{r}
system.file("extdata", "ch4.xlsx", package = "aelab", mustWork = T)
```
...
```{r}
calculate_regression(ch4, ghg = "CH4", reference_time = as.POSIXct("2023-03-11 07:32:00 UTC"))
```
