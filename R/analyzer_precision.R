...
#'   \item{precision_ppm}{Instrument precision in ppm (1σ, 1 s) (numeric).}
#' }
#' @source LI-COR Biosciences product specifications; LGR (Los Gatos Research) UGGA product specifications.
#' @examples
#' analyzer_precision
